...
const VARIABLE_TYPES = exports.VARIABLE_TYPES = LIBPG_ENUMS['nodes/parsenodes'].VariableSetKind.values.reduce((m, v, i) => {
  if (i === 0) {
    return m;
  } // skip first noop
  m[v.name] = i - 1;
...
const TYPES = exports.TYPES = LIBPG_ENUMS['nodes/parsenodes'].ObjectType.values.reduce((m, v, i) => {
  if (i === 0) {
    return m;
  } // skip first noop
  m[v.name] = i - 1;
