...
export declare enum JsonQuotes {
    JS_QUOTES_UNSPEC = 0,
    JS_QUOTES_KEEP = 1,
    JS_QUOTES_OMIT = 2
}
export declare enum JsonTableColumnType {
...
export declare enum TableFuncType {
    TFT_XMLTABLE = 0,
    TFT_JSON_TABLE = 1
}
...
export declare enum JsonWrapper {
    JSW_UNSPEC = 0,
    JSW_NONE = 1,
    JSW_CONDITIONAL = 2,
    JSW_UNCONDITIONAL = 3
}
export declare enum JsonBehaviorType {
...
export declare enum JsonExprOp {
    JSON_EXISTS_OP = 0,
    JSON_QUERY_OP = 1,
    JSON_VALUE_OP = 2,
    JSON_TABLE_OP = 3
...
export declare enum MergeMatchKind {
