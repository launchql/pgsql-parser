...
it('original-upstream-xmlmap', async () => {
  ...
  "original/upstream/xmlmap-35.sql",
  "original/upstream/xmlmap-36.sql",
  "original/upstream/xmlmap-37.sql",
  "original/upstream/xmlmap-38.sql",
