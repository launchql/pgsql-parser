...
export default {
  ...
  tableFunc(_p?: TableFunc["TableFunc"]): TableFunc {
    ...
    _o.set(_j, "TableFunc.functype", _p?.functype);
    ...
    _o.set(_j, "TableFunc.colvalexprs", _p?.colvalexprs);
    _o.set(_j, "TableFunc.passingvalexprs", _p?.passingvalexprs);
    _o.set(_j, "TableFunc.notnulls", _p?.notnulls);
    _o.set(_j, "TableFunc.plan", _p?.plan);
  ...
  windowFunc(_p?: WindowFunc["WindowFunc"]): WindowFunc {
    ...
    _o.set(_j, "WindowFunc.runCondition", _p?.runCondition);
  ...
  windowFuncRunCondition(_p?: WindowFuncRunCondition["WindowFuncRunCondition"]): WindowFuncRunCondition {
    ...
    } as WindowFuncRunCondition;
    _o.set(_j, "WindowFuncRunCondition.xpr", _p?.xpr);
    _o.set(_j, "WindowFuncRunCondition.opno", _p?.opno);
    _o.set(_j, "WindowFuncRunCondition.inputcollid", _p?.inputcollid);
    _o.set(_j, "WindowFuncRunCondition.wfunc_left", _p?.wfunc_left);
    _o.set(_j, "WindowFuncRunCondition.arg", _p?.arg);
    return _j;
  },
  mergeSupportFunc(_p?: MergeSupportFunc["MergeSupportFunc"]): MergeSupportFunc {
    ...
    _o.set(_j, "MergeSupportFunc.xpr", _p?.xpr);
    _o.set(_j, "MergeSupportFunc.msftype", _p?.msftype);
    _o.set(_j, "MergeSupportFunc.msfcollid", _p?.msfcollid);
    _o.set(_j, "MergeSupportFunc.location", _p?.location);
    return _j;
  },
  ...
  jsonBehavior(_p?: JsonBehavior["JsonBehavior"]): JsonBehavior {
    ...
    _o.set(_j, "JsonBehavior.btype", _p?.btype);
    _o.set(_j, "JsonBehavior.expr", _p?.expr);
    _o.set(_j, "JsonBehavior.coerce", _p?.coerce);
    _o.set(_j, "JsonBehavior.location", _p?.location);
    return _j;
  },
  jsonExpr(_p?: JsonExpr["JsonExpr"]): JsonExpr {
    ...
    _o.set(_j, "JsonExpr.xpr", _p?.xpr);
    _o.set(_j, "JsonExpr.op", _p?.op);
    _o.set(_j, "JsonExpr.column_name", _p?.column_name);
    _o.set(_j, "JsonExpr.formatted_expr", _p?.formatted_expr);
    _o.set(_j, "JsonExpr.format", _p?.format);
    _o.set(_j, "JsonExpr.path_spec", _p?.path_spec);
    _o.set(_j, "JsonExpr.returning", _p?.returning);
    _o.set(_j, "JsonExpr.passing_names", _p?.passing_names);
    _o.set(_j, "JsonExpr.passing_values", _p?.passing_values);
    _o.set(_j, "JsonExpr.on_empty", _p?.on_empty);
    _o.set(_j, "JsonExpr.on_error", _p?.on_error);
    _o.set(_j, "JsonExpr.use_io_coercion", _p?.use_io_coercion);
    _o.set(_j, "JsonExpr.use_json_coercion", _p?.use_json_coercion);
    _o.set(_j, "JsonExpr.wrapper", _p?.wrapper);
    _o.set(_j, "JsonExpr.omit_quotes", _p?.omit_quotes);
    _o.set(_j, "JsonExpr.collation", _p?.collation);
    _o.set(_j, "JsonExpr.location", _p?.location);
    return _j;
  },
  jsonTablePath(_p?: JsonTablePath["JsonTablePath"]): JsonTablePath {
    ...
    _o.set(_j, "JsonTablePath.name", _p?.name);
    return _j;
  },
  jsonTablePathScan(_p?: JsonTablePathScan["JsonTablePathScan"]): JsonTablePathScan {
    const _j = {
      JsonTablePathScan: {}
    } as JsonTablePathScan;
    _o.set(_j, "JsonTablePathScan.plan", _p?.plan);
    _o.set(_j, "JsonTablePathScan.path", _p?.path);
    _o.set(_j, "JsonTablePathScan.errorOnError", _p?.errorOnError);
    _o.set(_j, "JsonTablePathScan.child", _p?.child);
    _o.set(_j, "JsonTablePathScan.colMin", _p?.colMin);
    _o.set(_j, "JsonTablePathScan.colMax", _p?.colMax);
    return _j;
  },
  jsonTableSiblingJoin(_p?: JsonTableSiblingJoin["JsonTableSiblingJoin"]): JsonTableSiblingJoin {
    const _j = {
      JsonTableSiblingJoin: {}
    } as JsonTableSiblingJoin;
    _o.set(_j, "JsonTableSiblingJoin.plan", _p?.plan);
    _o.set(_j, "JsonTableSiblingJoin.lplan", _p?.lplan);
    _o.set(_j, "JsonTableSiblingJoin.rplan", _p?.rplan);
    return _j;
  },
  ...
  mergeAction(_p?: MergeAction["MergeAction"]): MergeAction {
    ...
    _o.set(_j, "MergeAction.matchKind", _p?.matchKind);
  ...
  query(_p?: Query["Query"]): Query {
    ...
    _o.set(_j, "Query.mergeTargetRelation", _p?.mergeTargetRelation);
    _o.set(_j, "Query.mergeJoinCondition", _p?.mergeJoinCondition);
  ...
  mergeWhenClause(_p?: MergeWhenClause["MergeWhenClause"]): MergeWhenClause {
    ...
    _o.set(_j, "MergeWhenClause.matchKind", _p?.matchKind);
  ...
  jsonArgument(_p?: JsonArgument["JsonArgument"]): JsonArgument {
    ...
    _o.set(_j, "JsonArgument.val", _p?.val);
    _o.set(_j, "JsonArgument.name", _p?.name);
    return _j;
  },
  jsonFuncExpr(_p?: JsonFuncExpr["JsonFuncExpr"]): JsonFuncExpr {
    ...
    _o.set(_j, "JsonFuncExpr.op", _p?.op);
    _o.set(_j, "JsonFuncExpr.column_name", _p?.column_name);
    _o.set(_j, "JsonFuncExpr.context_item", _p?.context_item);
    _o.set(_j, "JsonFuncExpr.pathspec", _p?.pathspec);
    _o.set(_j, "JsonFuncExpr.passing", _p?.passing);
    _o.set(_j, "JsonFuncExpr.output", _p?.output);
    _o.set(_j, "JsonFuncExpr.on_empty", _p?.on_empty);
    _o.set(_j, "JsonFuncExpr.on_error", _p?.on_error);
    _o.set(_j, "JsonFuncExpr.wrapper", _p?.wrapper);
    _o.set(_j, "JsonFuncExpr.quotes", _p?.quotes);
    _o.set(_j, "JsonFuncExpr.location", _p?.location);
    return _j;
  },
  jsonTablePathSpec(_p?: JsonTablePathSpec["JsonTablePathSpec"]): JsonTablePathSpec {
    const _j = {
      JsonTablePathSpec: {}
    } as JsonTablePathSpec;
    _o.set(_j, "JsonTablePathSpec.string", _p?.string);
    _o.set(_j, "JsonTablePathSpec.name", _p?.name);
    _o.set(_j, "JsonTablePathSpec.name_location", _p?.name_location);
    _o.set(_j, "JsonTablePathSpec.location", _p?.location);
    return _j;
  },
  jsonTable(_p?: JsonTable["JsonTable"]): JsonTable {
    ...
    _o.set(_j, "JsonTable.context_item", _p?.context_item);
    _o.set(_j, "JsonTable.pathspec", _p?.pathspec);
    _o.set(_j, "JsonTable.passing", _p?.passing);
    _o.set(_j, "JsonTable.columns", _p?.columns);
    _o.set(_j, "JsonTable.on_error", _p?.on_error);
    _o.set(_j, "JsonTable.alias", _p?.alias);
    _o.set(_j, "JsonTable.lateral", _p?.lateral);
    _o.set(_j, "JsonTable.location", _p?.location);
    return _j;
  },
  jsonTableColumn(_p?: JsonTableColumn["JsonTableColumn"]): JsonTableColumn {
    ...
    _o.set(_j, "JsonTableColumn.coltype", _p?.coltype);
    _o.set(_j, "JsonTableColumn.name", _p?.name);
    _o.set(_j, "JsonTableColumn.typeName", _p?.typeName);
    _o.set(_j, "JsonTableColumn.pathspec", _p?.pathspec);
    _o.set(_j, "JsonTableColumn.format", _p?.format);
    _o.set(_j, "JsonTableColumn.wrapper", _p?.wrapper);
    _o.set(_j, "JsonTableColumn.quotes", _p?.quotes);
    _o.set(_j, "JsonTableColumn.columns", _p?.columns);
    _o.set(_j, "JsonTableColumn.on_empty", _p?.on_empty);
    _o.set(_j, "JsonTableColumn.on_error", _p?.on_error);
    _o.set(_j, "JsonTableColumn.location", _p?.location);
    return _j;
  },
  ...
  jsonParseExpr(_p?: JsonParseExpr["JsonParseExpr"]): JsonParseExpr {
    ...
    _o.set(_j, "JsonParseExpr.expr", _p?.expr);
    _o.set(_j, "JsonParseExpr.output", _p?.output);
    _o.set(_j, "JsonParseExpr.unique_keys", _p?.unique_keys);
    _o.set(_j, "JsonParseExpr.location", _p?.location);
    return _j;
  },
  jsonScalarExpr(_p?: JsonScalarExpr["JsonScalarExpr"]): JsonScalarExpr {
    ...
    _o.set(_j, "JsonScalarExpr.expr", _p?.expr);
    _o.set(_j, "JsonScalarExpr.output", _p?.output);
    _o.set(_j, "JsonScalarExpr.location", _p?.location);
    return _j;
  },
  jsonSerializeExpr(_p?: JsonSerializeExpr["JsonSerializeExpr"]): JsonSerializeExpr {
    const _j = {
      JsonSerializeExpr: {}
    } as JsonSerializeExpr;
    _o.set(_j, "JsonSerializeExpr.expr", _p?.expr);
    _o.set(_j, "JsonSerializeExpr.output", _p?.output);
    _o.set(_j, "JsonSerializeExpr.location", _p?.location);
    return _j;
  },
  ...
  mergeStmt(_p?: MergeStmt["MergeStmt"]): MergeStmt {
    ...
    _o.set(_j, "MergeStmt.returningList", _p?.returningList);
  ...
  constraint(_p?: Constraint["Constraint"]): Constraint {
    ...
    _o.set(_j, "Constraint.inhcount", _p?.inhcount);
  ...
  transactionStmt(_p?: TransactionStmt["TransactionStmt"]): TransactionStmt {
    ...
    _o.set(_j, "TransactionStmt.location", _p?.location);
    return _j;
  },
  ...
  deallocateStmt(_p?: DeallocateStmt["DeallocateStmt"]): DeallocateStmt {
    ...
    _o.set(_j, "DeallocateStmt.isall", _p?.isall);
    _o.set(_j, "DeallocateStmt.location", _p?.location);
    return _j;
  },
